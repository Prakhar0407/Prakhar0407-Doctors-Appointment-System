  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      const { data } = await axios.get(
        "https://prakhar0407-doctors-appointment-system.onrender.com/api/v1/user/doctors",
  ...
  const handleAppointment = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://prakhar0407-doctors-appointment-system.onrender.com/api/v1/appointment/post",
        {
          firstName,
          lastName,
          email,
